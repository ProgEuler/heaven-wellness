...
const CATEGORIES = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1544161515-436cefd54cbf?q=80&w=2070&auto=format&fit=crop',
  },
  {
    id: 'activities',
    title: 'Activities',
    ...
    <View style={[styles.container, { backgroundColor: background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, { paddingTop: headerHeight }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: textMuted }]}>Choose your wellness experience</Text>
        </View>
