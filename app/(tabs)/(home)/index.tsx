...
export default function HomeScreen() {
  ...
  const styles = createStyles(background, border, textMuted, primary, brownGold, lightBeige);
      ...
      <View style={styles.sectionHeader}>
        ...
        <Card style={styles.upcomingVisitCard}>
          <View style={styles.upcomingVisitInfo}>
            ...
            <View>
              <Text style={styles.upcomingVisitTitle}>Lunchroom Reservation</Text>
              <Text variant="caption" style={styles.upcomingVisitTime}>Fri 20 Feb • 01:30 PM</Text>
            </View>
          </View>
...
const createStyles = (background: string, border: string, textMuted: string, primary: string, brownGold: string, lightBeige: string) => StyleSheet.create({
  container: {
    flex: 1,
...
const itemStyles = (iconBg: string, textMuted: string) => StyleSheet.create({
  detailItemCon: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
...
const actionCardStyles = (border: string, labelBg: string, brownGold: string, textMuted: string) => StyleSheet.create({
  actionCard: {
    flex: 1,
    padding: 20,
    borderRadius: 20,
